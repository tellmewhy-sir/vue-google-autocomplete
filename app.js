...
exports.default = {
    ...
    mounted: function mounted() {
         ...
         * */
        if (this.types) {
            var trimStr = this.types.replace(/\s+/g, '');
            var split = trimStr.split(',');
            options.types = split;
    ...
    methods: {
        ...
        filterGeocodeResultTypes: function filterGeocodeResultTypes(results) {
            ...
            var types = this.types; // this.types is already an array now
...
Component.options.__file = "/Users/PICdavid/Documents/dev./forks/vue-google-autocomplete/src/VueGoogleAutocomplete.vue"
